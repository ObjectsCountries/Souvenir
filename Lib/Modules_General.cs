...
public partial class SouvenirModule
{
    ...
    const string _CharacterShift = "characterShift";
    ...
    const string _FlavorTextEX = "FlavorTextCruel";
    ...
    const string _ForgetMeNow = "ForgetMeNow";
    ...
    const string _SimonServes = "simonServes";
    ...
    void Awake()
    {
        _moduleProcessors = new Dictionary<string, (Func<KMBombModule, IEnumerable<object>> processor, string moduleName, string contributor)>()
        {
            ...
            [_CharacterShift] = (ProcessCharacterShift, "Character Shift", "Kuro"),
            ...
            [_CyanButton] = (ProcessCyanButton, "Cyan Button, The", "Quinn Wuest"),
            ...
            [_FlavorTextEX] = (ProcessFlavorTextEX, "Flavor Text EX", "Hawker"),
            ...
            [_ForgetMeNow] = (ProcessForgetMeNow, "Forget Me Now", "Kuro"),
            ...
            [_LetterMath] = (ProcessLetterMath, "Letter Math", "Quinn Wuest"),
            ...
            [_NotColoredSwitches] = (ProcessNotColoredSwitches, "Not Colored Switches", "Quinn Wuest"),
            [_NotConnectionCheck] = (ProcessNotConnectionCheck, "Not Connection Check", "Quinn Wuest"),
            [_NotCoordinates] = (ProcessNotCoordinates, "Not Coordinates", "Quinn Wuest"),
            ...
            [_NotTheBulb] = (ProcessNotTheBulb, "Not The Bulb", "Quinn Wuest"),
            ...
            [_NotX01] = (ProcessNotX01, "Not X01", "Quinn Wuest"),
            ...
            [_Parity] = (ProcessParity, "Parity", "Quinn Wuest"),
            ...
            [_SimonSaid] = (ProcessSimonSaid, "Simon Said", "Quinn Wuest"),
            ...
            [_SimonServes] = (ProcessSimonServes, "Simon Serves", "Hawker"),
            ...
            [_TripleTerm] = (ProcessTripleTerm, "Triple Term", "Quinn Wuest"),
            ...
            [_XobekuJehT] = (ProcessXobekuJehT, "xobekuJ ehT", "Quinn Wuest"),
